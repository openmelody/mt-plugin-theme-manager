package Test::MT::ThemeManager::BlogUpgrader::Beta;
...
subtest "BlogUpgrader object" => sub {
    ...
    is( $blog_theme->ts_id, 'beta_theme', 'blog->theme is beta _theme' );
    is( $upgrader_theme->ts_id, 'beta_theme',
        'upgrader->theme is beta_theme' );
...
subtest "BlogUpgrader Theme Meta" => sub {
    ...
    is( $upgrader->_save_theme_meta(), 1,
        'Saved theme meta' );
    my $theme = $blog->theme;
    is( $theme->ts_id, 'beta_theme', 'Installed theme ts_id' );
    is( $theme->ts_label, 'Beta Theme', 'Installed theme label' );
    is( $theme->version, '1.10.0', 'Installed theme version' );
